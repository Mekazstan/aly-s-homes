            ...
            >
                ...
                <div className={cn(
                        ...
                        <Link href="/" className="flex items-center gap-3">
                            ...
                            {!isCollapsed && (
                                <div className="animate-in fade-in slide-in-from-left-2 duration-300">
                                    ...
                                    <p className="text-[10px] uppercase tracking-[0.2em] font-bold gold-text-gradient">Premium Living</p>
                                </div>
                            )}
                        </Link>
                        <button
                    ...
                    <nav className="flex-grow space-y-1">
                        {!isCollapsed && (
                            <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-slate-500 mb-4 ml-3 animate-in fade-in duration-300">Resident Portal</p>
                        )}
                        {navItems.map((item) => {
                    ...
                    <div className="mt-auto pt-6 border-t border-slate-200 grid gap-2">
                        ...
                        <button
                            ...
                            className={cn(
                                "flex items-center gap-3 py-3 rounded-xl text-red-400 hover:text-red-300 hover:bg-red-400/5 transition-all duration-200 mt-2",
                                isCollapsed ? "px-0 justify-center" : "px-4"
                            )}
                        >
